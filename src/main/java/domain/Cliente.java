...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoInteligente(contadorId, "aire acondicionado de 3500 frigorias", 1.613,
//				Estados.APAGADO);
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoInteligente(contadorId, "aire acondicionado de 2200 frigorias", 1.013,
//				Estados.APAGADO);
//		dispositivo.setUsoMensualMinimoHoras(90);
//		dispositivo.setUsoMensualMaximoHoras(360);
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoEstandar(contadorId, "Color de tubo fluorescente de 21 pulgadas",
//				0.075);
//		dispositivo.setUsoMensualMinimoHoras(90);
//		dispositivo.setUsoMensualMaximoHoras(360);
//		dispositivo.setBajoConsumo(false);
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoEstandar(contadorId, "Color de tubo fluorescente de 29 a 34 pulgadas",
//				0.175);
//		dispositivo.setUsoMensualMinimoHoras(90);
//		dispositivo.setUsoMensualMaximoHoras(360);
//		dispositivo.setBajoConsumo(false);
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoInteligente(contadorId, "Heladera sin freezer", 0.075,
//				Estados.APAGADO);
//		dispositivo.setUsoMensualMinimoHoras(0);
//		dispositivo.setUsoMensualMaximoHoras(0);
//		dispositivo.setBajoConsumo(true);
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoEstandar(contadorId,
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoInteligente(contadorId, "Lavarropas automatico de 5kg", 0.175,
//				Estados.APAGADO);
//		dispositivo.setUsoMensualMinimoHoras(6);
//		dispositivo.setUsoMensualMaximoHoras(30);
//		dispositivo.setBajoConsumo(true);
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoInteligente(contadorId, "Lampara Halogena de 40 W", 0.04,
//				Estados.APAGADO);
//		dispositivo.setUsoMensualMinimoHoras(90);
//		dispositivo.setUsoMensualMaximoHoras(360);
//		dispositivo.setBajoConsumo(false);
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoInteligente(contadorId, "Lampara Halogena de 60 W", 0.06,
//				Estados.APAGADO);
//		dispositivo.setUsoMensualMinimoHoras(90);
//		dispositivo.setUsoMensualMaximoHoras(360);
//		dispositivo.setBajoConsumo(false);
...
//		contadorId++;
//		Dispositivo dispositivo = new DispositivoInteligente(contadorId, "Lampara Halogena de 100 W", 0.015,
//				Estados.APAGADO);
//		dispositivo.setUsoMensualMinimoHoras(90);
//		dispositivo.setUsoMensualMaximoHoras(360);
//		dispositivo.setBajoConsumo(false);
